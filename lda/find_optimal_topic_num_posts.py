...
cn.write_csv_for_db_update(f'../lda/csv/coherences_and_perplexities/community_{community}_coherences_perplexities_posts.csv', fields, coherences_perplexities)